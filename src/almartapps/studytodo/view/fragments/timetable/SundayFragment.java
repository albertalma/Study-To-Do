...
public class SundayFragment extends ListFragment {
	...
	public void onResume() {
		super.onResume();
		new GetAllSundayClassTask().execute();
	}
	
	 private class GetAllSundayClassTask extends AsyncTask<Void, Void, Boolean> {
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				try {
					scheduledClassList = scheduledClassDAO.getScheduledClasses(WeekDay.sunday, subjectIds);
				} catch (Exception e) {
