...
public class TuesdayFragment extends ListFragment {
	...
	public void onResume() {
		super.onResume();
		new GetAllTuesdayClassTask().execute();
	}
	
	 private class GetAllTuesdayClassTask extends AsyncTask<Void, Void, Boolean> {
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				try {
					scheduledClassList = scheduledClassDAO.getScheduledClasses(WeekDay.tuesday, subjectIds);
				} catch (Exception e) {
