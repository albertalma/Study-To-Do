...
public class FridayFragment extends ListFragment {
	...
	public void onResume() {
		super.onResume();
		new GetAllFridayClassTask().execute();
	}
	
	 private class GetAllFridayClassTask extends AsyncTask<Void, Void, Boolean> {
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				try {
					scheduledClassList = scheduledClassDAO.getScheduledClasses(WeekDay.friday, subjectIds);
				} catch (Exception e) {
