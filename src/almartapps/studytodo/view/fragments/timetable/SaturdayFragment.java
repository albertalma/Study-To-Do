...
public class SaturdayFragment extends ListFragment {
	...
	public void onResume() {
		super.onResume();
		new GetAllSaturdayClassTask().execute();
	}
	
	 private class GetAllSaturdayClassTask extends AsyncTask<Void, Void, Boolean> {
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				try {
					scheduledClassList = scheduledClassDAO.getScheduledClasses(WeekDay.saturday, subjectIds);
				} catch (Exception e) {
