...
public class ThursdayFragment extends ListFragment {
	...
	public void onResume() {
		super.onResume();
		new GetAllThursdayClassTask().execute();
	}
	
	 private class GetAllThursdayClassTask extends AsyncTask<Void, Void, Boolean> {
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				try {
					scheduledClassList = scheduledClassDAO.getScheduledClasses(WeekDay.thursday, subjectIds);
				} catch (Exception e) {
